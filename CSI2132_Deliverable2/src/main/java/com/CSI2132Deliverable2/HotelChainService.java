...
public class HotelChainService {
    ...
    public String createHotelChain(HotelChain hotelChain) throws Exception {
        ...
        String sql = "INSERT INTO HotelChain (hotelChainID, addressOfCentralOffices, numberOfHotels, emailAddressID, phoneNumberID)"
                + " VALUES (?, ?, ?, ?, ?)";
        ...
        try {
            ...
            st.setInt(4, hotelChain.getEmailAddressID());
            st.setInt(5, hotelChain.getPhoneNumberID());
    ...
    public String updateHotelChain(HotelChain hotelChain) throws Exception {
        ...
        String sql = "UPDATE HotelChain"
                + "SET addressOfCentralOffices=?, numberOfHotels=?, emailAddressID=?, phoneNUmberID=?"
                + "WHERE hotelChainID=?";
        //Connection to database
        Connection con = null;
        //Database connection object
        ...
        try {
            ...
            st.setInt(3, hotelChain.getEmailAddressID());
            st.setInt(4, hotelChain.getPhoneNumberID());
