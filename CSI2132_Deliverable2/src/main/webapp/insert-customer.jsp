...
<body>
    ...
    <div class="container">
        <div class="row" id="row">
            <div class="col-md-12">
                <form class="form-horizontal" name="customer-form" action="insert-customer-controller.jsp" method="POST">
                    ...
                    <div class="form-group col-sm-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="idType" placeholder="Enter Type of ID">
                    </div>
                    <div class="form-group col-sm-3 mb-3">
