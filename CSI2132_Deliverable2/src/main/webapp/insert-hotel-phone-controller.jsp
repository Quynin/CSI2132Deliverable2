...
<%
    System.out.println("INT: " + request.getParameter("phoneNumberID") + "AFTER");
    System.out.println("String: " + request.getParameter("phoneNumberString") + "AFTER");
    int id = Integer.parseInt(request.getParameter("phoneNumberID"));
    String string = request.getParameter("phoneNumberString");

    HotelPhoneNumberService service = new HotelPhoneNumberService();
    // create new phone number object
    HotelPhoneNumber phoneNumber = new HotelPhoneNumber(id, string);

    Message msg;
    // try to create a new phone number
    try {

        String value = service.createPhoneNumber(phoneNumber);
